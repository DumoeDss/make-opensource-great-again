    ...
    <div className="relative">
      ...
      {isOpen ? createPortal(
        <>
          ...
          <div
            ref={dropdownRef}
            className="fixed z-[70] pointer-events-auto bg-popover border border-border rounded-lg shadow-lg overflow-hidden"
            style={posStyle}
          >
    ...
    <div className="relative">
      ...
      {isOpen ? createPortal(
        <>
          ...
          <div
            ref={dropdownRef}
            className="fixed z-[70] pointer-events-auto bg-popover border border-border rounded-lg shadow-lg overflow-hidden flex flex-col"
            style={posStyle}
          >
            {searchable ? (
  ...
  return createPortal(
    <>
      ...
      <div
        ref={dropdownRef}
        className={cn(
          'fixed z-[70] pointer-events-auto max-h-64 overflow-auto rounded-lg border border-border bg-popover shadow-lg',
          className
        )}
        style={posStyle}
      >
