/**
 * Dialog - Radix UI based dialog component (ported from omnicross, MIT).
 * The `wallpaper-solid` skin class is stripped (MOSGA has no wallpaper layer);
 * `bg-surface-0` remains. tailwindcss-animate is NOT installed, so the
 * `animate-*` / `data-[state]` utilities are inert — dialogs still open/close.
 */
