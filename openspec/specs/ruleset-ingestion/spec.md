...
Defines how `@mosga/sanitizer` ingests, translates, and compiles the vendored gitleaks ruleset plus user custom rules into a single deterministic, shared artifact consumable by both the tool and downstream CI.
