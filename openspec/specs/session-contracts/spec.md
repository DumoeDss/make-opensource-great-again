...
Defines the `@mosga/contracts` package: the zod schemas and inferred TypeScript types (reader references, parsed messages, and the sanitized-session envelope) that every mosga slice — readers, sanitizer, review-ui, publish — aligns to.
